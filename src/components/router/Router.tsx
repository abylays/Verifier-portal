...
import LoanPage from 'pages/user/LoanPage.js'
...
const Router = ({isUserAuthenticated}: Props) => {
    ...
    if (!isUserAuthenticated) {
        return (
            <Switch>
                ...
                <Route exact path={routes.CREATE_TOKEN} component={ApiKeyPage}/>
    ...
    return (
        <Switch>
            ...
            <Route exact path={routes.INTRO} component={IntroPage}/>
            <Route exact path={routes.LOAN_PAGE} component={LoanPage}/>
